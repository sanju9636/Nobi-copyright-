...
gd_buttons = [              
        [
            InlineKeyboardButton("ᴜᴘᴅᴀᴛᴇ", url="https://t.me/TitanXSupport"),
            InlineKeyboardButton("sᴜᴘᴘᴏʀᴛ", url="https://t.me/Want_To_Know_Mee"),    
        ]
        ]
# ------------------------------------------------------------------------------- #
